...
(function ($, window, document) {
    ...
    function getCalendarData(dateStr) {
        //TODO 请求计划列表
        setTimeout(function () {
            $.gjk.ajax.requestPostOrder('dailyRecord/planInfos', {
    ...
    function getAjaxData(dateStr) {
        ...
        dateTime = dateStr;
        setTimeout(function () {
            $.gjk.ajax.requestPostOrder('dailyRecord/findLogByDate', {
                date: dateStr
            }, function (res) {
