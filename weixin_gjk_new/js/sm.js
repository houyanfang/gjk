...
+function ($) {
    ...
    $.fn.calendar = function (params) {
        ...
        this.each(function() {
            ...
            res.push(new Calendar($.extend(p, params)));
        });
        return res;
    };
...
+ function($) {
    ...
    var Picker = function (params) {
        ...
        p.initPickerCol = function (colElement, updateItems) {
            ...
            col.updateItems = function (activeIndex, translate, transition, valueCallbacks) {
                ...
                */
                ...
                if("时分".indexOf(col.items.text())==-1){
                	selectedItem = selectedItem.eq(activeIndex).addClass('picker-selected').transform('');
                }
        ...
        p.recovery = function(){
        	if(p.prevValue)
        	{
        		p.setValue(p.prevValue, 0);
        	}
        };
        //recovery
        if(p.params.recovery)
        {
        	$(document).on('click', p.params.recovery, p.recovery);
        }
