	...
	var _success = function(obj){
		if(obj.data){
			...
			$("#pharname").picker({
			    ...
			    <button class="button button-link pull-left button-no">取消</button>\
...
function setAddress(){
	$("#city-picker").cityPicker({
		toolbarTemplate: '<header class="bar bar-nav">\
		<button class="button button-link pull-left button-no close-picker">取消</button>\
		<button class="button button-link pull-right close-picker button-yes">确定</button>\
		</header>'				
	});
...
function setBrankInfor(){
	...
	var _success = function(obj){
        ...
        $("#brank").picker({
			toolbarTemplate: '<header class="bar bar-nav">\
			<button class="button button-link pull-left close-picker button-no">取消</button>\
			<button class="button button-link pull-right close-picker button-yes">确定</button>\
			<h1 class="title"></h1>\
			</header>',
			cols: [
			...
			onClose:function(picker)
			{
				var currenValue = picker.cols[0].value; //$("#brank").data("picker").cols[0].value;
